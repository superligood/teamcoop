      ...
      <div class="l-left">
        <div class="desc">
          ...
          <div style="margin-top: 30px" class="link">
            <a href="" target="_blank"><span>11</span></a>
          </div>
        </div>
      </div>
      <div class="login">
          ...
          <div class="login-form">
            ...
            <div class="form-user" @keypress="loginPress">
              <div class="item">
                ...
                <div class="f-input">
                  <el-input v-focus type="text" v-model="userInfo.userName" placeholder="输入用户" />
                </div>
              </div>
              <div class="item">
                <div class="f-text">
                ...
                <div class="f-input">
                  <el-input v-focus type="password" v-model="userInfo.password" placeholder="输入密码" />
                </div> 
              </div>
              <div class="item">
                <div class="f-text"><label> 验证码： </label></div>
                <div class="f-input"><el-input v-focus type="text" v-model="userInfo.verificationCode" placeholder="输入验证码" /></div>
                <div class="code" @click="getVierificationCode"><img v-show="codeImgSrc != ''" :src="codeImgSrc" /></div>
              </div>
            </div>
  ...
  setup(props, context) {
   ...
   // getVierificationCode();
    ...
    const login = () => {
      ...
      // }
      loading.value = true;//, userInfo, "正在登录...."
      http.post("/ProjectManager/api/Tasks/Query").then((result) => {
        sessionStorage.setItem("ADID","Qiang.Huang");
        if (result){
